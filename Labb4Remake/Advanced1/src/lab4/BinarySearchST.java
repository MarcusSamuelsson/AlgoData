...
public class BinarySearchST<Key extends Comparable<Key>, Value> {
    ...
    public Key[] keys;
    private int[] vals;
    public String[] pairs;  //Hold the node names who are adjacent to a node
    private int n = 0;
    ...
    //Returns the index associated with the sent in key
    ...
    public Iterable<Key> keys(Key lo, Key hi) {
        ...
        lab4.Queue<Key> queue = new lab4.Queue<Key>();
